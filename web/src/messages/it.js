...
l'inventario proviene da <i>Johnson's (2014) IPIP NEO-PI-R di 120 elementi</i>.`,
  ...
  openness_to_experience: {
    ...
    seo: {
      ...
      description:
        'Ulteriori informazioni sulla apertura alla esperienza dominio nel modello b5'
    }
  },
  conscientiousness: {
    title: 'Coscienziosità',
    seo: {
      ...
      description:
        'Ulteriori informazioni sul dominio della coscienziosità nel modello b5'
    }
  },
  extraversion: {
    title: 'Estroversione',
    seo: {
      ...
      description:
        'Ulteriori informazioni sul dominio estroversione nel modello b5'
    }
  },
  agreeableness: {
    title: 'Piacevolezza',
    seo: {
      ...
      description:
        'Ulteriori informazioni sul dominio della piacevolezza nel modello b5'
    }
  },
  neuroticism: {
    title: 'Nevrosi',
    seo: {
      ...
      description:
        'Ulteriori informazioni sul dominio della nevrosi nel modello b5'
    }
  },
  getCompare: {
  ...
  results: {
    ...
    saveResults:
      'Salva il seguente IS per vedere i risultati in un secondo momento o ',
    compare: 'compara',
